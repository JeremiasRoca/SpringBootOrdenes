...
import proyecto.proyecto.Documentation.TicketExcelReport;
import proyecto.proyecto.Documentation.TicketPdfReport;
import proyecto.proyecto.Email.Email;
import proyecto.proyecto.Email.EmailService;
...
public class TicketController {
    ...
    public ResponseEntity<Object> save(@RequestBody TicketRequest ticket)
    {
        try
        {
           Ticket t = tS.save(new Ticket(ticket));
